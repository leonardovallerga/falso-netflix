...
const TMDB_API = {
  ...
  movies: {
    popular: "/movie/popular?api_key=" + API_KEY + "&language=es-Es",
    topRated: "/movie/top_rated?api_key=" + API_KEY + "&language=es-Es",
  },
  series: {
    popular: "/tv/popular?api_key=" + API_KEY + "&language=es-Es",
    topRated: "tv/top_rated?api_key=" + API_KEY + "&language=es-Es",
  },
};
